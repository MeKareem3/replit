...
const numOfPeopleInput = document.getElementById("numberOfPeople")
const perPersonTotalAmount = document.getElementById("perPersonTotal")

let numberOfPeople = Number(numOfPeopleInput.innerText)
...
numberOfPeople += 1 
  ...
  numOfPeopleInput.innerText = numberOfPeople
